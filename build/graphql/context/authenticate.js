...
exports.default = async (request, context) => {
    if (request.request.headers.authorization &&
        ...
        const user = await typeorm_1.getConnection().transaction(async (manager) => {
            var _a, _b, _c;
            ...
            const result = await manager.getRepository(User_1.default).insert({
                email: (_a = decodedToken.email) !== null && _a !== void 0 ? _a : null,
                name: (_b = decodedToken.name) !== null && _b !== void 0 ? _b : "",
                profileImageURL: (_c = decodedToken.picture) !== null && _c !== void 0 ? _c : "",
            ...
            if (!createdUser)
                throw new Error("User generation failed. No new user was successfully created.");
            return createdUser;
        });
        return { ...context, user };
    }
